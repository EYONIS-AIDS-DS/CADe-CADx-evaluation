...
list_series_evaluations_figure_4 = [
...
list_series_evaluations_figure_extended_2 = [
...
list_series_evaluations_figure_extended_3 = [
...
list_series_evaluations_figure_extended_9 = [
...
list_series_evaluations_figure = [
    ...
    (list_series_evaluations_figure_4,          "figure_4",          path_data_series),
    (list_series_evaluations_figure_extended_2, "figure_extended_2", path_data_series),
    (list_series_evaluations_figure_extended_3, "figure_extended_3", path_data_series),
    (list_series_evaluations_figure_extended_9, "figure_extended_9", path_data_series),
]
...
list_lesions_evaluations_figure_2 = [
#    ("test1", "model_prediction",                       "label",       [0,], ["Youden Index Max"]),
#    ("test3", "model_prediction",                       "label",       [0,], ["Youden Index Max"]),
    ("test3", "4_radiologist_prediction",               "label",       [0,], ["Youden Index Max"]), 
...
list_lesions_evaluations_figure_3 = [
    ("4_10_mm_test3",  "model_prediction",         "label",[0,],["Youden Index Max"]),
    ("10_20_mm_test3", "model_prediction",         "label",[0,],["Youden Index Max"]),
    ("20_30_mm_test3", "model_prediction",         "label",[0,],["Youden Index Max"]),
    ("4_10_mm_test3",  "4_radiologist_prediction", "label",[0,],["Youden Index Max"]),
...
list_lesions_evaluations_figure_extended_5 = [
...
list_lesions_evaluations_figure_extended_9 = [
    ("test6",  "delta_volume",             "label", [0,], ["Youden Index Max"]),
...
list_lesions_evaluations_figure = [
    (list_lesions_evaluations_figure_2,          "figure_2",          path_data_lesions),
    (list_lesions_evaluations_figure_3,          "figure_3",          path_data_lesions),
    (list_lesions_evaluations_figure_4,          "figure_4",          path_data_lesions_longitudinal),
    (list_lesions_evaluations_figure_extended_5, "figure_extended_5", path_data_lesions),
    (list_lesions_evaluations_figure_extended_9, "figure_extended_9", path_data_lesions_longitudinal),
]
...
list_of_tuples_of_pairs_of_bootstrap_paths_figure_2 = [
...
figure_name = "figure_extended_3"
root = path_model_eval / "evaluate_series"/ figure_name
list_of_tuples_of_pairs_of_bootstrap_paths_figure_extended_3 = [
...
figure_name = "figure_extended_9"
root = path_model_eval / "evaluate_series"/ figure_name
root2 =  path_model_eval / "evaluate_lesions"/ figure_name
list_of_tuples_of_pairs_of_bootstrap_paths_figure_extended_9 = [
...
list_statistical_tests_figure = [
    ...
    (list_of_tuples_of_pairs_of_bootstrap_paths_figure_2,          "figure_2",),
    (list_of_tuples_of_pairs_of_bootstrap_paths_figure_3,          "figure_3",),
    (list_of_tuples_of_pairs_of_bootstrap_paths_figure_4,          "figure_4",),
    (list_of_tuples_of_pairs_of_bootstrap_paths_figure_extended_3, "figure_extended_3",),
    (list_of_tuples_of_pairs_of_bootstrap_paths_figure_extended_9, "figure_extended_9",),
]